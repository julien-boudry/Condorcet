...
```php
public Tools\Converters\CondorcetElectionFormat->setDataToAnElection ( [?CondorcetPHP\Condorcet\Election election = null , ?Closure callBack = null] ): CondorcetPHP\Condorcet\Election
```
