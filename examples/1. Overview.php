...
// IV - Votes
    ...
    # -B- Manage Votes
        ...
        # 2- Vote objet
            ...
            $myVote3->getContextualVote($election1); // Return the full ranking in the context of election 1 (with 6 candidates). It is one that is taken into account when calculating the results of the election 1.
