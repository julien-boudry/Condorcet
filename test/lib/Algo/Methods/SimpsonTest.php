...
/**
 * @covers \Condorcet\Algo\Methods\Simpson
 */
class SimpsonTest extends TestCase
{
    /**
     * @var election
     */
    ...
    public function testResult_1 ()
    {
        ...
        self::assertSame($CandidateCora,$this->election->getWinner('Simpson'));

        self::assertSame(
            $this->election->getResult('Simpson')->getResultAsArray(true),
            [   1 => 'Cora',
                2 => 'Abby',
                3 => 'Brad',
                4 => 'Dave',
