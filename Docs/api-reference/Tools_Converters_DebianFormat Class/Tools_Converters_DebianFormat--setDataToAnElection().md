...
> [Read it at the source](https://github.com/julien-boudry/Condorcet/blob/master/src/Tools/Converters/DebianFormat.php#L68)
...
* [DavidHillFormat::setDataToAnElection()]()    
