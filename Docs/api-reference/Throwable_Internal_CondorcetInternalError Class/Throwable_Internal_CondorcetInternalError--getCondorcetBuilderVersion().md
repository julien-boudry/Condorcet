# public Throwable\Internal\CondorcetInternalError::getCondorcetBuilderVersion
...
```php
public Throwable\Internal\CondorcetInternalError->getCondorcetBuilderVersion ( [bool $major = false] ): string
```
...
* [\CondorcetPHP\Condorcet\Condorcet::getVersion()]()    
