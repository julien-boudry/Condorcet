...
test('get votes count with candidates all combination', function (): void {
    ...
    // 4
    $election->addCandidate('F');
    // 5
    $election->addCandidate('G');
    // 6
    $election->addCandidate('H');
    // 7
    $election->addCandidate('I');
    // 8
    $election->addCandidate('J');
